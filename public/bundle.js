...
_reactDom2.default.render(_react2.default.createElement(_IndecisionApp2.default, { optionArray: ['abc', 'def'] }), document.getElementById('root'));
...
/*
 ...
 LICENSE file in the root directory of this source tree.
*/
var f=__webpack_require__(2),p=__webpack_require__(4);__webpack_require__(5);var r=__webpack_require__(3);
...
var _AddOptions = __webpack_require__(23);
...
var IndecisionApp = function (_React$Component) {
	...
	function IndecisionApp(props) {
		...
		_this.removeAllData = _this.removeAllData.bind(_this);
		_this.handlePick = _this.handlePick.bind(_this);
		_this.handleAddOptions = _this.handleAddOptions.bind(_this);
		_this.handleDeleteData = _this.handleDeleteData.bind(_this);
		_this.state = { optionArray: props.optionArray };
		return _this;
	}
	...
	_createClass(IndecisionApp, [{
		...
		value: function componentDidUpdate(prevProps, prevState) {
			if (prevState.optionArray.length !== this.state.optionArray.length) {

				var json = JSON.stringify(this.state.optionArray);
		...
		key: 'handleDeleteData',
		value: function handleDeleteData(opt) {
			this.setState(function (prevState) {
				return {
					optionArray: prevState.optionArray.filter(function (optFilter) {
						return optFilter !== opt;
					})
				};
			});
		}
		...
		value: function handleAddOptions(option) {
			if (!option) return 'Enter valide value';else if (this.state.optionArray.indexOf(option) > -1) return 'this option alredy exist';
			this.setState(function (prevState) {
				return { optionArray: prevState.optionArray.concat(option) };
			});
		}
	}, {
		key: 'handlePick',
		value: function handlePick() {
			...
			console.log(this.state.optionArray[Math.floor(Math.random() * this.state.optionArray.length)]);
		}
	}, {
		key: 'removeAllData',
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(_Action2.default, { hasOptionArray: this.state.optionArray.length > 0, handlePick: this.handlePick }),
				_react2.default.createElement(_Option2.default, { optionArray: this.state.optionArray,
...
var AddOptions = function (_React$Component) {
	...
	_createClass(AddOptions, [{
		...
		value: function handleAddOptions(event) {
			event.preventDefault();
			var inputForm = event.target.elements.option.value.trim();
			var error = this.props.handleAddOptions(inputForm);
			this.setState(function () {
				return { error: error };
			});
			if (!error) {
				return event.target.elements.option.value = '';
			}
		}
	}, {
		key: 'render',
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement('input', { type: 'text', name: 'option', placeholder: 'something' }),
					_react2.default.createElement(
						'button',
						null,
						'add option'
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			...
			{ onClick: function onClick(e) {
					props.handleDeleteData(props.optionText);
				} },
			'Remove'
		)
	);
